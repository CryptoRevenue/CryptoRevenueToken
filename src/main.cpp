...
const string strMessageMagic = "CryptoRevenueToken Signed Message:\n";
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // CryptoRevenueToken: check proof-of-stake block signature
...
// CryptoRevenueToken: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CryptoRevenueToken", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Spain Joins World War On Cash, Bitcoin Emerges As Viable Alternative 03-12-2016";
        CTransaction txNew;
        txNew.nTime = 1480771822;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	block.print();
        ...
        assert(block.hashMerkleRoot == uint256("0x2b7a0631f185a8696b3bad00e46296aeb1db26b382663242e2869986a77abece"));
